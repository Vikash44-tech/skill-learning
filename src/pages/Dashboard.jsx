                  ...
                  {activeTab === 'messages' && (
                    ...
                    >
                       ...
                       <div className="flex flex-col gap-6">
                          {messages.map(msg => (
                            <div key={msg.id} className={`p-6 rounded-3xl border flex items-start gap-6 transition-all cursor-pointer ${
                              msg.unread ? 'bg-indigo-50/50 border-indigo-100' : 'bg-slate-50/30 border-slate-50 opacity-70 hover:opacity-100'
                            }`}>
